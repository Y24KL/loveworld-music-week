...
export default function Home() {
  ...
  return (
    <div className="bg-neutral-950 text-white min-h-screen relative font-sans overflow-x-hidden selection:bg-amber-500/30 selection:text-amber-200">
      ...
      {/* CINEMATIC BACKGROUND GLOWS (Matching Logo Palette) */}
      <div className="absolute top-[-10%] left-[-10%] w-[600px] h-[600px] bg-blue-600/15 rounded-full blur-[150px] pointer-events-none" />
      <div className="absolute top-[30%] right-[-10%] w-[500px] h-[500px] bg-fuchsia-500/10 rounded-full blur-[130px] pointer-events-none" />
      <div className="absolute bottom-[10%] left-[5%] w-[700px] h-[700px] bg-amber-500/10 rounded-full blur-[160px] pointer-events-none" />
      ...
      <section className="min-h-screen flex flex-col justify-center items-center px-4 pt-24 relative">
        <div className="text-center max-w-4xl space-y-6 z-10 flex flex-col items-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-white/[0.03] border border-white/10 rounded-full text-xs font-semibold tracking-widest text-amber-400 uppercase backdrop-blur-sm">
            <Sparkles size={12} /> Reaching the last lost man through music
          </div>
          ...
          <h1 className="text-5xl md:text-8xl font-black tracking-tight leading-none py-2">
            ...
            <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-fuchsia-400 to-amber-400 drop-shadow-[0_0_30px_rgba(59,130,246,0.25)]">
              Music Week
            </span>
          </h1>
      ...
      <section id="about" className="py-32 px-6 max-w-7xl mx-auto relative z-20 scroll-mt-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          <div className="lg:col-span-5 space-y-4">
            <p className="text-xs uppercase font-bold tracking-widest text-fuchsia-400">The Context</p>
          ...
          <div className="lg:col-span-7 bg-white/[0.01] border border-white/5 p-8 md:p-12 rounded-3xl backdrop-blur-xl space-y-6 text-neutral-300 leading-relaxed text-base md:text-lg">
            <p>
              LoveWorld Music Week is a divinely inspired global convergence designed to standardize, elevate, and align spiritual music production with ultimate excellence. It is an active spiritual laboratory where divine blueprints meet state-of-the-art technological systems.
            </p>
      ...
      <section id="achievements" className="py-32 bg-neutral-900/30 border-y border-white/5 relative z-20">
        <div className="max-w-7xl mx-auto px-6 space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-b from-white/[0.02] to-transparent border border-white/5 p-8 rounded-2xl flex flex-col space-y-4 hover:border-fuchsia-500/20 transition-all group">
              <div className="w-12 h-12 rounded-xl bg-fuchsia-500/10 border border-fuchsia-500/20 flex items-center justify-center text-fuchsia-400 group-hover:scale-110 transition-transform">
                <Cpu size={22} />
              </div>
      ...
      <section className="py-32 px-6 max-w-5xl mx-auto relative z-20 text-center space-y-12">
        <div className="space-y-4">
          ...
          <p className="text-neutral-400 text-base max-w-xl mx-auto">
            Choose your deployment vector below to synchronize with ongoing preparations and Partner with Us.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
          {/* LINK A: FIXED ACCESS BUTTON */}
          <div className="bg-white/[0.01] border border-white/5 p-8 rounded-2xl backdrop-blur-md flex flex-col justify-between items-start space-y-6 shadow-2xl shadow-blue-500/5">
            ...
            <Link 
              href="/resources" 
              className="w-full py-4 bg-white/5 hover:bg-white/10 border border-white/10 text-white rounded-xl transition-all font-bold flex items-center justify-center gap-2 text-sm group"
            >
