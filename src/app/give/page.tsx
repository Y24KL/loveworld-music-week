...
// 1. Move the complete giving portal content and handlers here
...
// 2. The default export safely wraps the interface to clear the build compiler boundary
    ...
    <Suspense
      fallback={
        <div className="min-h-screen bg-neutral-950 flex items-center justify-center pt-24 pb-12 px-4 sm:px-8 relative overflow-hidden">
          <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-amber-500/10 rounded-full blur-[120px] pointer-events-none" />
          <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-purple-600/10 rounded-full blur-[100px] pointer-events-none" />
          <div className="w-full max-w-md bg-white/[0.02] border border-white/5 rounded-3xl p-10 backdrop-blur-xl relative z-10 shadow-2xl text-center flex flex-col items-center justify-center">
            ...
            <p className="text-xs text-gray-400 uppercase tracking-widest animate-pulse">
              Loading Secure Partnership Interface...
            </p>
          </div>
        </div>
      }
